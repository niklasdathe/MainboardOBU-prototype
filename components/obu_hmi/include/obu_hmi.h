...
typedef struct {float speed_kmh;bool speed_valid;bool phone_connected;bool c5_online;bool gnss_valid;bool glosa_valid;float glosa_target_kmh;obu_hmi_warning_t warning;char warning_text[48];} obu_hmi_model_t;
